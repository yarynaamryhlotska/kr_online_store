  ...
  <?php check_message(); ?>
      <div class="">
        <div class="panel panel-default">
          ...
          <div>Every products has a mininum price of &#8364 50.00 each to be able to order.</div>
      <div class="table-responsive">
       <div  class="fixnmix_scroll_carttwo" >
         ...
         <tbody > 
            ...
            ?>
                      <tr>
                        ...
                        <td>&#8364 <?php echo number_format($result->PRICE,2) ?></td>
                        ...
                        <td>&#8364 <output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price'] ; ?></output>
        ...
        ?>
                  ...
                  <table  >
                  <tfoot >
                     <strong><h1 align="right">Total Price : &#8364 <span style="margin-right:3%"  id="sum">0.00</span></h1></strong></td>
