...
class User {
    ...
    // Функція отримання назв полів таблиці
    function dbfields () {
        global $mydb;
	...
	static function userAuthentication($U_USERNAME, $h_pass){
        ...
        $U_USERNAME = $mydb->escape_value($U_USERNAME); // Екрануємо дані
        $h_pass = $mydb->escape_value($h_pass); // Екрануємо дані
        ...
        $row_count = $mydb->num_rows($cur); // Отримуємо кількість записів
